...
import i5.las2peer.services.CitrecHandler.CitrecHandlerService;
...
public class ServiceTest {
		...
		public void startServer() throws Exception {
			...
			node.startService(new ServiceNameVersion(CitrecHandlerService.class.getName(), "1.0.0"), "a pass");
